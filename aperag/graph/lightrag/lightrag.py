...
class LightRAG:
    ...
    async def _grouping_process_chunk_results(
        ...
        # Collect entity/relation details for provenance
        all_entity_details = []
        all_relation_details = []
        for r in results:
            all_entity_details.extend(r.get("entity_details", []))
            all_relation_details.extend(r.get("relation_details", []))
        ...
        return {
            ...
            "relation_details": all_relation_details,
        }
    ...
    async def aprocess_graph_indexing(
        ...
        try:
            ...
            return {
                ...
                "relation_details": result.get("relation_details", []),
            }
