...
async def _merge_nodes_and_edges_impl(
    ...
    for entity_name, entities in all_nodes.items():
        ...
        async with entity_lock:
            ...
            # Collect entity details for provenance
            if entity_data:
                source_ids = entity_data.get("source_id", "").split(GRAPH_FIELD_SEP) if entity_data.get("source_id") else []
    ...
    for edge_key, edges in all_edges.items():
        ...
        async with relationship_lock:
            ...
            if edge_data is not None:
                ...
                # Collect relation details for provenance
                source_ids = edge_data.get("source_id", "").split(GRAPH_FIELD_SEP) if edge_data.get("source_id") else []
