...
async def _process_document_async(
    ...
    try:
        ...
        # Process results
        total_stats = {
            "chunks_created": 0, "entities_extracted": 0, "relations_extracted": 0,
            "documents": [], "entity_details": [], "relation_details": [],
        }
        ...
        for doc_result in results:
            ...
            if chunks_data:
                ...
                total_stats["entity_details"].extend(graph_result.get("entity_details", []))
                total_stats["relation_details"].extend(graph_result.get("relation_details", []))
