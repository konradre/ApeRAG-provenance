...
class DocumentService:
    ...
    async def _create_document_record(
        ...
        # Record DOCUMENT_VERSION provenance
        try:
            from aperag.db.models_provenance import ArtifactType, generate_run_id
            ...
            prov.create_node(
                ...
                location={"object_path": upload_path},
                depth=0,
                ancestor_ids=[],
                path_types=[],
            )
        except Exception:
            logger.warning("Failed to record DOCUMENT_VERSION provenance for doc %s", document_instance.id)
